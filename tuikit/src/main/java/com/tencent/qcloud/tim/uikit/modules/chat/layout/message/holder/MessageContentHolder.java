...
//        }
        ...
        if (profile == null) {
            TIMFriendshipManager.getInstance().getUsersProfile(Collections.singletonList(msg.getFromUser()),
                    true,
                    new TIMValueCallBack<List<TIMUserProfile>>() {
                        ...
                        public void onSuccess(List<TIMUserProfile> timUserProfiles) {
                            TIMUserProfile pf = timUserProfiles.get(0);
                            if (usernameText.getText().toString().equals(pf.getIdentifier())){
                                if (TextUtils.isEmpty(msg.getGroupNameCard())) {
                                    usernameText.setText(!TextUtils.isEmpty(pf.getNickName()) ? pf.getNickName() : msg.getFromUser());
                                } else {
        ...
        if (msg.isSelf()) {
            if (properties.getRightBubble() != null && properties.getRightBubble().getConstantState() != null) {
                ...
                msgContentFrame.setBackgroundResource(R.drawable.item_message_self_bg);
            }
        } else {
            if (properties.getLeftBubble() != null && properties.getLeftBubble().getConstantState() != null) {
                ...
                msgContentFrame.setBackgroundResource(R.drawable.item_message_other_bg);
            }
        }
