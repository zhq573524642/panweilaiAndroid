        ...
        public static RecyclerView.ViewHolder getInstance(ViewGroup parent, RecyclerView.Adapter adapter, int viewType) {
            ...
            switch (viewType) {
                ...
                case MessageInfo.MSG_TYPE_CUSTOM:
                    ...
                    break;
                case MessageInfo.MSG_TYPE_CUSTOM_SELF_GIFT:
                    holder = new MessageCustomGiftHolder(view, true);
                    break;
                case MessageInfo.MSG_TYPE_CUSTOM_OTHER_GIFT:
                    holder = new MessageCustomGiftHolder(view, false);
                    break;
                case MessageInfo.MSG_TYPE_CUSTOM_ANCHOR_CALL:
                    holder = new MessageCustomCallbackHolder(view);
                    break;
                case MessageInfo.MSG_TYPE_CUSTOM_CALL:
