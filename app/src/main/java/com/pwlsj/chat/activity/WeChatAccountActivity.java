...
public class WeChatAccountActivity extends BaseActivity {
                            ...
                            for (AccountBean bean : accountBeans) {
                                if (bean.t_type == 1) {//0.支付宝 1.微信
                                    ...
                                    if (!TextUtils.isEmpty(bean.qrCode)) {
                                        ...
                                        ImageLoadHelper.glideShowImageWithUrl(WeChatAccountActivity.this,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.code_fl: {//上传收款码
                mMoneyDesTv.setVisibility(View.GONE);
                //图片选择
                ImageHelper.openPictureChoosePage(WeChatAccountActivity.this, REQUEST_MONEY_CODE);
                break;
            }
        }
    }
    ...
    private void uploadCodeWithQQ() {
        ...
        PutObjectRequest putObjectRequest = new PutObjectRequest(Constant.TENCENT_CLOUD_BUCKET,
                cosPath, mSelectLocalPath);
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_MONEY_CODE) {//选择收款码
                ...
                if (resultUri != null) {
                    ...
                    ImageLoadHelper.glideShowImageWithUri(WeChatAccountActivity.this,
