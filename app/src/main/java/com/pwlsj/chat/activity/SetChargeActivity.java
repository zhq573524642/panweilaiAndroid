...
import com.pwlsj.chat.bean.CharSetBean;
            ...
            public void onResponse(BaseResponse<ChargeBean> response, int id) {
                ...
                if (response != null && response.m_istatus == NetCode.SUCCESS) {
                    ...
                    if (bean != null) {
                        ...
                        mAudioChatTv.setText(bean.t_voice_gold + getString(R.string.gold));

                        int phoneGold = bean.t_phone_gold;
                        if (phoneGold > 0) {
                        ...
                        int wechatGold = bean.t_weixin_gold;
                        if (wechatGold > 0) {
