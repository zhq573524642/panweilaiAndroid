...
import com.pwlsj.chat.util.ViewShotUtil;
import com.pwlsj.chat.util.ZXingUtils;
import com.pwlsj.chat.util.permission.PermissionUtil;
import com.pwlsj.chat.view.Xcircleindicator;
import com.pwlsj.chat.view.gallery.CardAdapter;
import com.pwlsj.chat.view.gallery.CardScaleHelper;
...
public class PromotionPosterActivity extends BaseActivity {
    ...
    public void onClick(View view) {
        if (TextUtils.isEmpty(shareUrl)) {
            getShareUrl();
            ToastUtil.showToast(gettedData ? "分享链接错误，请联系客服" : "正在获取数据中...");
            return;
        }
