...
import com.pwlsj.chat.pay.PayResult;
...
public class PayChooserActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (payId == 0) {
            ...
            findViewById(R.id.go_pay_tv).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    private void startPay(Activity context, int payType, String response) {
        if (!TextUtils.isEmpty(response)) {
             ...
             */
                ...
                ToastUtil.showToast(object.getString("m_strMessage"));
            }
        }
    }
