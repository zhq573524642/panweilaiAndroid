...
import com.pwlsj.chat.adapter.MultipleMessageRecyclerAdapter;
...
import com.pwlsj.chat.bean.MultipleChatInfo;
import com.pwlsj.chat.constant.ChatApi;
import com.pwlsj.chat.dialog.InputDialogFragment;
import com.pwlsj.chat.dialog.InvalidChatDialog;
import com.pwlsj.chat.dialog.Invite1v2Dialog;
import com.pwlsj.chat.dialog.MultipleGiftDialog;
            ...
            if (isManager) {
                ...
                TIMGroupManager.getInstance().createGroup(param, new TIMValueCallBack<String>() {
                    ...
                    public void onError(int code, String desc) {
                        ToastUtil.showToast("消息注册失败" + code);
                    }
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (BuildConfig.DEBUG) {
                        ToastUtil.showToast(uid + "离开房间" + reason);
                    }
