...
import com.pwlsj.chat.adapter.ChargeRecyclerAdapter;
import com.pwlsj.chat.adapter.PayOptionRecyclerAdapter;
...
import com.pwlsj.chat.bean.PayOptionBean;
...
public class ChargeActivity extends BaseActivity {
    ...
    private void initStart() {
        ...
        mOptionRecyclerAdapter.setOnItemSelectListner(new PayOptionRecyclerAdapter.OnItemSelectListner() {
            @Override
            public void onItemSelected(PayOptionBean bean) {
                if (bean != null) {
                    mSelectedBean = bean;
