...
import com.pwlsj.chat.activity.RankProtectActivity;
import com.pwlsj.chat.activity.UserCommentActivity;
...
import com.pwlsj.chat.bean.DynamicPreBean;
...
import com.pwlsj.chat.bean.ProtectRankBean;
...
import com.pwlsj.chat.view.StarView;
...
public class PersonDataFragment extends BaseFragment {
        ...
        OkHttpUtils
                ...
                .execute(new AjaxCallback<BaseResponse<List<ProtectRankBean>>>() {
                    ...
                    public void onResponse(BaseResponse<List<ProtectRankBean>> response, int id) {
                        ...
                        findViewById(R.id.protect_ll).setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                RankProtectActivity.start(mContext, otherId);
                            }
                        });
                    }
                });
        ...
        OkHttpUtils
                ...
                .execute(new AjaxCallback<BaseResponse<List<CommentBean>>>() {
                    ...
                    public void onResponse(BaseResponse<List<CommentBean>> response, int id) {
                        ...
                        findViewById(R.id.comment_ll).setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                UserCommentActivity.start(mContext, JSON.toJSONString(response.m_object));
                            }
                        });
        ...
        PageRequester<ActiveBean<ActiveFileBean>> pageRequester = new PageRequester<ActiveBean<ActiveFileBean>>() {
            ...
            public void onSuccess(List<ActiveBean<ActiveFileBean>> list, boolean isRefresh) {
                ...
                dynamicBtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InfoActiveActivity.start(mContext, otherId);
                    }
                });
    ...
    private void setContact(final ActorInfoBean<CoverUrlBean, LabelBean, ChargeBean, InfoRoomBean> bean) {
        ...
        View.OnClickListener lookClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new LookNumberDialog(mContext, bean, (int) v.getTag(), otherId).show();
            }
        };
...
//        findViewById(R.id.close_tv).setOnClickListener(closeClick);
        ...
        final View.OnClickListener giftClick = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
