...
import com.pwlsj.chat.activity.CommonWebViewActivity;
...
import com.pwlsj.chat.bean.MansionActorBean;
import com.pwlsj.chat.constant.ChatApi;
import com.pwlsj.chat.constant.Constant;
import com.pwlsj.chat.dialog.CreateMultipleRoomDialog;
import com.pwlsj.chat.dialog.MansionPermissionDialog;
import com.pwlsj.chat.dialog.MansionInviteDialog;
        ...
        if (contentRv.getAdapter() == null) {
            ...
            AbsRecycleAdapter adapter = new AbsRecycleAdapter(
                ...
                public void convert(ViewHolder holder, Object t) {
                    ...
                    if (bean.isChoice) {
                        ...
                        holder.<TextView>getView(R.id.nick_name).setText("点击邀请");
            ...
            adapter.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(View view, Object obj, int position) {
                    if (isFemale()) {
                        ToastUtil.showToast(mContext, R.string.only_man_can_one_vs_two);
                        return;
                    }
                    if (noMansionPermission()) {
                        return;
