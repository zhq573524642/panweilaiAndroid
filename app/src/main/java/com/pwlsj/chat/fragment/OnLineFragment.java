...
import com.pwlsj.chat.adapter.OnLineRecyclerAdapter;
...
public class OnLineFragment extends BaseFragment {
    ...
    private OnLineRecyclerAdapter mAdapter;
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        mAdapter = new OnLineRecyclerAdapter(mContext);
        mContentRv.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(new OnLineRecyclerAdapter.OnItemClickListener() {
            @Override
    ...
    private void getUserList(final RefreshLayout refreshlayout, final boolean isRefresh, int page) {
        ...
        OkHttpUtils.post().url(ChatApi.GET_ROOM_USER_LIST())
