        ...
        view.findViewById(R.id.confirm_tv).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(code)) {
                    ToastUtil.showToast(mActivity, R.string.please_input_image_code);
                    return;
                }
                ...
                .execute(new AjaxCallback<BaseResponse>() {
                    ...
                    public void onResponse(BaseResponse response, int id) {
                        if (response.m_istatus == NetCode.SUCCESS) {
                            ...
                            ToastUtil.showToast(mActivity, R.string.wrong_image_code);
                        }
                    }
    ...
    private void sendSmsVerifyCode(String imageCode) {
        ...
        OkHttpUtils.post()
                ...
                .execute(new AjaxCallback<BaseResponse>() {
                    ...
                    @Override
                    public void onError(Call call, Exception e, int id) {
                        ToastUtil.showToast(mActivity, R.string.send_code_fail);
                    }
