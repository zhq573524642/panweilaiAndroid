...
import com.pwlsj.chat.activity.ActiveCommentActivity;
import com.pwlsj.chat.activity.ActorVideoPlayActivity;
import com.pwlsj.chat.activity.PhotoActivity;
...
import com.pwlsj.chat.dialog.LookResourceDialog;
...
import com.pwlsj.chat.view.ExpandTextView;
        ...
        if (fileBeans != null && fileBeans.size() > 0) {
            ...
            if (fileBeans.size() == 1) {
                ...
                mHolder.mOneImageFl.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (fileBean.t_file_type == 1) {//视频
                            ActorVideoPlayActivity.start(mContext, bean.t_id, fileBean.t_file_url);
                        } else {//图片
