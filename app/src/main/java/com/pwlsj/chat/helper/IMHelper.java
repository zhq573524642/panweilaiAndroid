...
import com.pwlsj.chat.bean.ServeBean;
import com.pwlsj.chat.constant.ChatApi;
import com.pwlsj.chat.im.ChatActivity;
import com.pwlsj.chat.im.ChatGroupActivity;
import com.pwlsj.chat.im.ImConstants;
...
//                ToastUtil.showToastLong(context, "消息系统登录失败,请重新登录");
//                exit(context);
                if (loginResult != null) {
                    loginResult.execute(false);
                }
