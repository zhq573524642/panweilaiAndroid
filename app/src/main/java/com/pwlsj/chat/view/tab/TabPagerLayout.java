package com.pwlsj.chat.view.tab;
...
public class TabPagerLayout extends HorizontalScrollView implements
    ...
    private void setSelected(int selected) {
        ...
        if (currentSelected >= 0) {
            pagerAdapter.getFragmentParam(currentSelected).getViewHolder().unSelected();
        }
        pagerAdapter.getFragmentParam(selected).getViewHolder().onSelected();
