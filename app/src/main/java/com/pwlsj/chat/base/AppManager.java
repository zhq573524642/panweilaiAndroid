...
import com.pwlsj.chat.activity.SplashActivity;
import com.pwlsj.chat.activity.UpdateActivity;
...
import com.pwlsj.chat.socket.ConnectService;
import com.pwlsj.chat.socket.SocketMessageManager;
import com.pwlsj.chat.socket.WakeupService;
...
//        BeautyManager.get().init();
        ...
        TiSDK.initSDK(Constant.TUOHUAN, this);
        //rtc
        RtcManager.get();
